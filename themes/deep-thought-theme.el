...
(custom-theme-set-faces
 ...
 '(default
   (
    (((class color) (min-colors 16777216)) (:foreground "#93a1a1" :background "#000F14"))
 ...
 '(mode-line
   ((t (:background "#001520" :box nil :foreground "#FFFFFF" :height 105))))

 '(mode-line-inactive
   ((t (:weight light :box nil :background "#001520" :foreground "#657b83" :inherit (mode-line)))))
 ...
 ;; Minibuffer
 '(minibuffer-prompt
   ((t (:weight bold :foreground "#208ae2" :height 115))))
